...
try : 
    ...
    waroot=Tk()
    waroot.geometry('400x45')
    waroot.title('Connection error')
    waroot.maxsize(400,45)
    waroot.minsize(400,45)
    Label(text='---Internet  connection Error---',relief='raised',font='cosmicsan 10 bold',fg='black',bg='red').pack(fill='x')
    Label(text='created by ambrish yadav',relief='ridge',font='cosmicsan 15 bold',fg='black',bg='cyan').pack(fill='x')
    waroot.mainloop()
